...
function activate(context) {
    ...
    let improveSelectedCode = vscode.commands.registerCommand('codegenie.improveCode', () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch('http://127.0.0.1:8000/improve', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ prompt: code, max_tokens: 1000 })
            });
            const result = yield response.json();
            const improved = (_a = result.response) === null || _a === void 0 ? void 0 : _a.trim();
    ...
    const inlineProvider = {
        provideInlineCompletionItems: (document, position, context, token) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let rawResponse = yield (0, api_1.fetchAICompletion)(textBeforeCursor, API_URL, 1000);
...
function generateCodeFromPrompt(editor, prompt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        statusBarItem.text = "$(sync~spin) CodeGenie: Generating...";
        try {
            const rawResponse = yield (0, api_1.fetchAICompletion)(prompt, API_URL, 1000);
